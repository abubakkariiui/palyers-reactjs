          ...
          {playersList
            ...
            .map((player, i) => {
              return (
                <tr
                  key={player}
                  class="bg-white border-b dark:bg-gray-800  hover:bg-gray-50 cursor-pointer dark:hover:bg-gray-600"
                >
                  <th
                    scope="row"
                  ...
                  <td class="py-4 px-6">{player?.position}</td>
                  <td class="py-4 px-6">{player?.organization}</td>
                  <td class="py-4 px-6">{player?.club}</td>
                </tr>
              );
            })}
        </tbody>
