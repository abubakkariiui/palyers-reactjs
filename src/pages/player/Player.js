...
function Player() {
  ...
  return (
    <div>
      ...
      <div
        div
        className="shadow-xl sm:rounded-lg p-4 border border-solid border-current"
      >
        ...
        />
        <Table
          data={player?.upcoming}
          title="Upcoming Events"
          allowedKeys={["date", "home", "away", "time", "venue"]}
        />
